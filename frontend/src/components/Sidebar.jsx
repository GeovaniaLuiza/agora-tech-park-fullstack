import { BarChart3, ClipboardList, FilePlus2, History, LayoutDashboard, LogOut, ShieldCheck, Users, X } from 'lucide-react';
...
const entries = [
  ...
  ['/indicators', 'Indicadores', BarChart3, ['ADMIN', 'PESQUISADOR', 'GESTOR']],
...
export default function Sidebar({ open, setOpen }) {
  ...
  return <aside className={`sidebar ${open ? 'open' : ''}`}>
    ...
    <div className="side-bottom"><button onClick={handleLogout}><LogOut />Sair</button></div>
  </aside>;
}
